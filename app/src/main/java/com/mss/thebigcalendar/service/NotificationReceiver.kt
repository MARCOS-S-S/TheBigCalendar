...
class NotificationReceiver : BroadcastReceiver() {
    ...
    private fun handleViewActivity(context: Context, intent: Intent) {
        ...
        // ✅ Exibir a notificação visual
        val notificationService = NotificationService(context)
        
        // Criar uma atividade temporária para exibir a notificação
        ...
        Log.d(TAG, "Notificação visual exibida com sucesso para: $activityTitle")
    }
